...
return [
    ...
    */
    ...
    'file_upload_error' => 'Ошибка загрузки файла, проверьте размер и формат.',
    ...
    */
    ...
    'custom' => [
        ...
        'service_ids.*' => [
            'exists' => 'Выбранное значение для Оказываемой услуги некорректно.'
        ],
        'start_days.*' => [
             'date_format' => 'Поле Время начала рабочего дня не соответствует формату :format.',
        ],
        'end_days.*' => [
            'date_format' => 'Поле Время окончания рабочего дня не соответствует формату :format.',
        ],
        'day_offs.*' => [
            'numeric' => 'Поле Выходной день должно быть числом.',
        ],
        'category_ids.*' => [
            'required' => 'Поле Привязанная категория обязательно для заполнения.',
            'exists' => 'Выбранное значение для Привязанная категория некорректно.',
        ],
        'monday.0' => [
            'date_format' => 'Поле Время начала рабочего дня понедельника не соответствует формату :format.',
        ],
        'monday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня понедельника не соответствует формату :format.',
        ],
        'tuesday.0' => [
            'date_format' => 'Поле Время начала рабочего дня вторника не соответствует формату :format.',
        ],
        'tuesday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня вторника не соответствует формату :format.',
        ],
        'wednesday.0' => [
            'date_format' => 'Поле Время начала рабочего дня среды не соответствует формату :format.',
        ],
        'wednesday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня среды не соответствует формату :format.',
        ],
        'thursday.0' => [
            'date_format' => 'Поле Время начала рабочего дня четверга не соответствует формату :format.',
        ],
        'thursday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня четверга не соответствует формату :format.',
        ],
        'friday.0' => [
            'date_format' => 'Поле Время начала рабочего дня пятницы не соответствует формату :format.',
        ],
        'friday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня пятницы не соответствует формату :format.',
        ],
        'saturday.0' => [
            'date_format' => 'Поле Время начала рабочего дня субботы не соответствует формату :format.',
        ],
        'saturday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня субботы не соответствует формату :format.',
        ],
        'sunday.0' => [
            'date_format' => 'Поле Время начала рабочего дня воскресенья не соответствует формату :format.',
        ],
        'sunday.1' => [
            'date_format' => 'Поле Время окончания рабочего дня воскресенья не соответствует формату :format.',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'price'                 => 'Стоимость',
        'category_ids'          => 'Привязанные категории',
        ...
        'today'                 => 'Сегодня',
        'start_days'            => 'Время начала рабочих дней',
        'end_days'              => 'Время окончания рабочих дней',
        'day_offs'              => 'Выходные дни',
        'status'                => 'Статус',
