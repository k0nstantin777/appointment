    ...
    */
    'bots'                         => [
        'mybot' => [
            ...
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', false),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'webhook_params'     => [
                'allowed_updates' => ['callback_query']
            ],
            'commands'            => [
                App\Services\TelegramBot\Commands\HelpCommand::class,
                App\Services\TelegramBot\Commands\NewVisitCommand::class,
                App\Services\TelegramBot\Commands\ShowCurrentVisitCommand::class,
            ],
        ],
    ],
